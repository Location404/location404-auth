...
public class UserApplication(string username, string email, string passwordHash, string passwordSalt) : BaseEntity
{
    public string DisplayName { get; private set; } = username;
    public string Username { get; private set; } = username;
    public string Email { get; private set; } = new Email(email).Value;
